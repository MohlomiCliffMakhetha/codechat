class Stickynotes extends HTMLElement {
        ...
        .then(htmlContent => {
          ...
          window.onload = function () {
            ...
            function loadStartEvents() {
              const createFirstSticky = shadow.querySelector("#createStickyBtn"); //for first empty existing sticky only
              shadow.onmouseup = hideDropMenu; //hides color menus when clicked anywhere in the page
            ...
            function hideDropMenu(e) {
              ...
              let stickies = Array.from(shadow.querySelectorAll(".sticky"));
              ...
              for (let i = 0; i < stickiesIdArray.length; i++) {
                let dropContent = shadow.querySelector(
                  `#${stickiesIdArray[i]} .dropdown-content-hide`
                );
                let dropButton = shadow.querySelector(
            ...
            function createSticky() {
              let parent = shadow.querySelector("#main");
              let sticky = shadow.querySelector(".sticky");
              ...
              let dropMenus = Array.from(
                shadow.querySelectorAll(".dropdown-content-hide")
              );
            ...
            function deleteSticky(e) {
              const createFirstSticky = shadow.querySelector("#createStickyBtn");
            ...
            function removeStickyFromDOM(key) {
              var sticky = shadow.getElementById(key);
            ...
            function toggleDropMenuClick(e) {
              ...
              let stickyContent = shadow.querySelector(`#${parentId} .sticky-content`);
              let dropMenu = shadow.querySelector(
            ...
            function storeSticky(e) {
              ...
              let notSaved = shadow.querySelector(`#${key} .notSaved`);
            ...
            function notSavedNotification(e) {
              ...
              let notSaved = shadow.querySelector(`#${stickyId} .notSaved`);
              notSaved.style.display = "inline-block";
  ...
  customElements.define('stickynotes-cc', Stickynotes);
